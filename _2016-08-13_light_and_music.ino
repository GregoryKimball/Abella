...
const int Selector_pin = 0 const int DIP_pin = 1 const int Clutch_pin = 2 const int Audio_pin = 11 const int Z_accel_pin = 3
...
void SetScale(double s)
{
  ...
  if (s > 50 - b && s < 50 + b)
    SetArray(notes, Cmajor, 15);
  if (s > 70 - b && s < 70 + b)
    SetArray(notes, Dmajor, 15);
  if (s > 112 - b && s < 112 + b)
    SetArray(notes, Emajor, 15);
  if (s > 161 - b && s < 161 + b)
    SetArray(notes, Fmajor, 15);
  if (s > 234 - b && s < 234 + b)
    SetArray(notes, Gmajor, 15);
  if (s > 335 - b && s < 335 + b)
    SetArray(notes, Amajor, 15);
  if (s > 468 - b && s < 468 + b)
    SetArray(notes, Bmajor, 15);
  if (s > 654 - b && s < 654 + b)
    SetArray(notes, Cmajorpent, 11);
  if (s > 663 - b && s < 663 + b)
    SetArray(notes, Dmajorpent, 11);
  if (s > 686 - b && s < 686 + b)
    SetArray(notes, Emajorpent, 11);
  if (s > 710 - b && s < 710 + b)
    SetArray(notes, Fmajorpent, 11);
  if (s > 744 - b && s < 744 + b)
    SetArray(notes, Gmajorpent, 11);
  if (s > 786 - b && s < 786 + b)
    SetArray(notes, Amajorpent, 11);
  if (s > 836 - b && s < 836 + b)
    SetArray(notes, Bmajorpent, 11);
